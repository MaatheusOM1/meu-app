...
const TarefaItem: React.FC<TarefaItemProps> = ({ id, titulo }) => {
    ...
    const handleExcluir = () => {
      excluirTarefa(id); // Chamando a função excluirTarefa com o ID da tarefa
    };
    ...
    return (
      ...
      >
        ...
        <IconButton
          ...
          colorScheme="light"
          onPress={handleExcluir} // Chamando a função handleExcluir ao clicar no botão de exclusão
